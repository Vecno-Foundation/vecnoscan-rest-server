...
class P2PStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MessageStream = channel.stream_stream(
                ...
                request_serializer=messages__pb2.VecnodMessage.SerializeToString,
...
def add_P2PServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MessageStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=messages__pb2.VecnodMessage.FromString,
    ...
    server.add_registered_method_handlers('protowire.P2P', rpc_method_handlers)
...
class P2P(object):
    ...
    def MessageStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/protowire.P2P/MessageStream',
            messages__pb2.VecnodMessage.SerializeToString,
