...
def toAddress(script):
    if script[0] == 0xAA and script[1] <= 0x76:
        return encodeAddress("vecno", script[2 : (2 + script[1])], 0x08)
    if script[0] < 0x76:
        # Version = 1 if ECDSA, else Version = 0
        version = 0x01 if (script[0] == 0x21 and script[34] == 0xAB) else 0x00
        return encodeAddress("vecno", script[1 : (1 + script[0])], version)
    raise NotImplementedError(script.hex())


# Uncomment for testing
# if __name__ == "__main__":
#     # Should be vecno:qyp7xyqdshh6aylqct7x2je0pse4snep8glallgz8jppyaajz7y7qeq4x79fq4z
...
#     print(test_ecdsa, test_ecdsa == "vecno:qyp7xyqdshh6aylqct7x2je0pse4snep8glallgz8jppyaajz7y7qeq4x79fq4z")

#     # Should be vecno:qrazhptjkcvrv23xz2xm8z8sfmg6jhxvmrscn7wph4k9we5tzxedwfxf0v6f8
...
#     print(test_schnorr, test_schnorr == "vecno:qrazhptjkcvrv23xz2xm8z8sfmg6jhxvmrscn7wph4k9we5tzxedwfxf0v6f8")
