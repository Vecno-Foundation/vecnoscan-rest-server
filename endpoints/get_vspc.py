...
@app.get("/info/get-vscp-from-block", response_model=VscpResponse, tags=["Vecno network info"])
async def get_virtual_selected_parent_chain_from_block(
    ...
    some startHash to this vecnod's current virtual.
    """
    resp = await vecnod_client.request("getVirtualSelectedParentChainFromBlockRequest",
                                       params={
                                           "startHash": startHash,
