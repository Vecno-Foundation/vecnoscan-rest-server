...
VECNOD_WRPC_URL = os.getenv("VECNOD_WRPC_URL")
...
match NETWORK_TYPE:
    case "mainnet":
        ...
        address_example = "vecno:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73"
    case "testnet":
        address_prefix = "vecnotest"
        address_example = "vecnotest:qpqz2vxj23kvh0m73ta2jjn2u4cv4tlufqns2eap8mxyyt0rvrxy6ejkful67"
    case "simnet":
        address_prefix = "vecnosim"
        address_example = "vecnosim:qpqz2vxj23kvh0m73ta2jjn2u4cv4tlufqns2eap8mxyyt0rvrxy6ejkful67"
    case _:
        raise ValueError(f"Network type {NETWORK_TYPE} not supported.")

ADDRESS_PREFIX = address_prefix
ADDRESS_EXAMPLE = address_example
GENESIS_MS = 1766273664560
